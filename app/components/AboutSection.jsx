  ...
  },
  {
    ...
    content: (
      <ul className="list-disc pl-2">
        ...
        <li>Masters In International Technology Transfer Management</li>
        <li>FHM University</li>
      </ul>
    ),
  },
  {
    ...
    content: (
      <ul className="list-disc pl-2">
        <li>Fullstack Developer(Integrify Academy)</li>
        <li>Java(SimpliLearn by Skillup)</li>
      </ul>
    ),
  },
];
